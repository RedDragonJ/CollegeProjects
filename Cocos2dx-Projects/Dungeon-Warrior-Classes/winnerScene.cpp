...
bool winner::init()
{
    ...
    this->gamewon->setScale(1,1);
    this->gamewon->setPosition(origin.x+visibleSize.width/2, origin.y+visibleSize.height/2);
    this->addChild(gamewon);
    
    auto play = MenuItemImage::create("menubutton.png", "menubutton.png", CC_CALLBACK_1(winner::GoToMainMenuScene, this));
    auto menu = Menu::create(play, NULL);
    menu->setPosition(origin.x+visibleSize.width/2, origin.y+visibleSize.height/2-80);
    menu->setScale(1);
...
void winner::update(float delta) {
...
void winner::GoToMainMenuScene(cocos2d::Ref* mynewscene){

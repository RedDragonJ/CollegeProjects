...
{
    //NSLog(@"before splite: %@", sma);
    NSMutableArray* array = [[NSMutableArray alloc]init];
    NSDictionary* myDict;
    for (NSString* obj in sma)
    {
        NSString* tempName = [sma objectAtIndex:[sma indexOfObject:obj]];//get object at current index
...
{
    NSLog(@"8");
    self.contactNames = [[NSMutableArray alloc]initWithArray:userInfos];
    NSLog(@"9");
